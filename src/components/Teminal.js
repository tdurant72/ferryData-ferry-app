...
const Terminal = props => {
    ...
    const checkProps = (props) => {
        if (props.terminalPushpin !== null) {
            let terminalPushpin = props.terminalPushpin;
            let terminalLocation = props.terminalLocation;
            terminalPushpin(props.terminalCoordinates, {
                title: props.terminalName,
                id: props.terminalName,
                icon: terminalIcon,

            });
            terminalLocation(props.terminalCoordinates)
            terminalPushpin.metadata = { id: props.terminalName, title: props.terminalName }
            terminalPushpin.setOptions({
                title: props.terminalName,
                id: props.terminalName
            })
            props.handleTerminalPinUpdate(terminalPushpin)
        } else {
            setTimeout(() => {
                this.checkProps()
            }, 1000)
    ...
    console.log(props.terminalPushpin)
