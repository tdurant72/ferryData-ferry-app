...
class App extends Component {
  ...
  // }
  // componentDidMount = () => {
  //   const json = localStorage.getItem("ferries");
  //   const ferries = JSON.parse(json);
  //   this.setState({ ferries: ferries });
  // }
  // componentDidUpdate = () => {
  //   const ferries = JSON.stringify(this.state.ferries);
  //   localStorage.setItem("ferries", ferries)
  // }
  render() {
    ...
    return (
      <div className="App">
        ...
        <div id="content-wrapper">
          ...
          <Ferries ferries={this.state.ferries} />
